...
my_theme = theme_bw(base_size=20) + 
    ...
    theme( axis.title=element_blank(),
           ...
           # we want no minor grid lines, not major ones on the x either, but thick black dotted ones on y
...
I won't say it was easier or quicker than doing it in base R, but it wasn't too bad, and I think the result are fairly pretty. 